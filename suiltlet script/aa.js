 ...
 */
define(['N/ui/serverWidget', 'N/record', 'N/format','N/email'],

    function (serverWidget, record, format,email) {
        ...
        function onRequest(context) {
            try {
                ...
                //post method =====================================================
                    ...
                    p_appliDob = new Date(p_appliDob);
...
var delemeter=/\u005/;
                    ...
                    var appliAoi = request.parameters.custpage_applicant_aoi_ap;


                    appliAoi=appliAoi.split(delemeter);
                     

                    log.debug('appliAoi', appliAoi);
                    ...
                    var p_appliNew = request.parameters.custpage_applicant_new_ap;
                    if (p_appliNew == 'T') {
