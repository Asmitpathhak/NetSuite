    ...
    function (search, record, file, runtime, email) {
            ...
            try{
                ...
                var customrecord_custom_purchase_order_list_SearchObj = search.create({
                 ...
                 customrecord_custom_purchase_order_list_SearchObj.run().each(function(result){
                        ...
                        cust_created_by=result.getText('custrecord_craeatedd_by_as');
                        ...
                        cust_vendor = result.getText('custrecord111415');
        ...
        function summarize(summary) {
           // var csvdata = 'Document Number,Date,Created by,total Amount,vendorname\r\n';
            var csvdata = 'vendorname,Document Number,Created by,Date,total Amount,\r\n';
            var counter = 0;
            var dataArray = [];
            ...
            for (var i = 0; i < dataArray.length; i++) {
                ...
                csvdata += rowData.cust_vendor + ',' + rowData.r_docNum + ',' + rowData.r_createdby + ',' + rowData.r_poDate +',' + rowData.r_totalAmount + '\r\n';
                counter++;
            }
            ...
            var fileObj = file.create({
                name: 'asmit pathak.csv',
                fileType: file.Type.CSV,
                contents: csvdata
            });

            fileObj.folder = 24049;
